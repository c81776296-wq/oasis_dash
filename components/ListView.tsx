                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex items-center gap-1 ml-auto border-l border-gray-200 dark:border-gray-800 pl-4 py-1 pr-1">
                                <div className="flex items-center gap-1.5 px-1.5">
                                  <button className="p-1 px-1.5 hover:bg-gray-100 dark:hover:bg-gray-800 rounded border border-gray-200 dark:border-gray-700 transition-colors"><MonitorPlay size={12} className="text-gray-400" /></button>
                                  <button className="p-1 px-1.5 hover:bg-gray-100 dark:hover:bg-gray-800 rounded border border-gray-200 dark:border-gray-700 transition-colors"><Smile size={12} className="text-gray-400" /></button>
                                </div>
